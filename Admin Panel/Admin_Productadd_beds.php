...
<head>
    ...
    <title>Product Adding - Beds</title>
...
?>
    ...
    <div class="container">
        ...
        <div style="color:#fda10d ; font-weight: 700; font-size:20px; margin-top: 50px; "> Add products - BEDS </div><br>

        <div class="col-10">
            <script class="jsbin" src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>

            <form action="Admin_Productadd_beds.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="file-upload">
                    <table>
                        <tr>
                            ...
                            <td> <input type="text" name="types" id="" value="BEDS NIM CREATIONS" style="width:400px; margin:10px" /><br></td>
                        </tr>
                        <tr>
...
function delete($id)
{
    ...
    $delete = "DELETE FROM beds WHERE id = $id ";
    $rundelete = mysqli_query($con, $delete);
    if ($rundelete) {
        echo "<script type='text/javascript'>alert('Data Deleted Succesfully!!');location='Admin_Productadd_beds.php';</script>";
    } else {
...
if (isset($_POST["Uploadsofa"])) {
    ...
    $ins = "INSERT INTO `beds` (`Product_Type`, `Model_No`, `Price`, `Desc` ,`Photo1`,`Photo2`, `Photo3`,`Photo4`,`Photo5`,`Metirial`) VALUES('$Product_type' , '$Product_name' , '$Price', '$Description','$image1', '$image2','$image3','$image4','$image5', '$color')";
    if (mysqli_query($connection, $ins)) {
        echo
        " <script>
                alert('Successfully Added');
                location='Admin_Productadd_beds.php';
