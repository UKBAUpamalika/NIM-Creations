    ...
    <div class="container">
        ...
        ?>
            ...
            <div class="col-10">
                ...
                <form action="Admin_Productadd_pantry.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="file-upload">
                        <table>
                            <tr>
                                ...
                                <td> <input type="text" name="types" id="" value="PANTRIES NIM CREATIONS" style="width:400px; margin:10px" /><br></td>
                            </tr>
                            <tr>
                            ...
                            while ($row = mysqli_fetch_array($query_run2)) { ?>
                                ...
                                <tr class="TR">
                                    <form action="" method="get">
                                        ...
                                        <td class="TD" style="height: 150px; overflow-y: scroll;">
                                            <?php echo  $row['Desc']; ?>
                                        </td>
...
<?php
            ...
            function delete($id)
            {
                ...
                $delete = "DELETE FROM pantries WHERE id = $id ";
...
*/
            ...
            if (isset($_POST["Uploadsofa"])) {
              ...
              ";
                ...
                $ins = "INSERT INTO `pantries` (`Product_Type`, `Model_No`, `Price`, `Desc` ,`Photo1`,`Photo2`, `Photo3`,`Photo4`,`Photo5`,`Metirial`) VALUES('$Product_type' , '$Product_name' , '$Price', '$Description','$image1', '$image2','$image3','$image4','$image5', '$color')";
                if (mysqli_query($connection, $ins)) {
                    echo
                    " <script>
                alert('Successfully Added');
                location='Admin_Productadd_pantry.php';
